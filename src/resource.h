...
namespace cg
{
	...
	struct vertex
	{
		...
		float v;
		float ambient_r;
		float ambient_g; // ambient colors - additional color
		float ambient_b;
		float diffuse_r;
		float diffuse_g; // diffuse colors - reflected color
		float diffuse_b;
		float emissive_r;
		float emissive_g; // emissive colors - color of light source (yellow light bulb, etc.)
		float emissive_b;
	};
